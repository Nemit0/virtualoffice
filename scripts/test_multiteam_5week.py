#!/usr/bin/env python3
"""
Multi-Team 5-Week Full Simulation
==================================

Full multi-team organizational structure:
- 1 Department with 1 Department Head
- 2 Teams (Team A and Team B)
- Each team has 1 Team Head (PM) + 2 Developers
- Each team works on 2 projects over 5 weeks (with different timelines)
- All report to Department Head

Total: 7 people (1 dept head + 2 team heads + 4 devs)
Projects: 4 total (2 per team with overlapping/sequential timelines)
"""
...
OUTPUT_DIR = ROOT_OUTPUT / f"multiteam_5week_{TIMESTAMP}"
...
def run_multiteam_simulation(people: List[Dict[str, Any]], teams: Dict[str, Any]) -> bool:
    """
    Runs 5-week simulation with 4 projects (2 per team):
    - Team A: Mobile App MVP (weeks 1-3) + Mobile App V2 (weeks 3-5)
    - Team B: Analytics Dashboard (weeks 1-2) + Data Pipeline (weeks 3-5)
    """
    log("🚀 Starting 5-week multi-team simulation...")

    start_request = {
        "project_name": "Multi-Team Engineering Department",
        "project_summary": "Department with two product teams working on multiple sequential/overlapping projects",
        "duration_weeks": 5,
        ...
        "projects": [
            # Team A Projects
            {
                ...
                "project_summary": "Build cross-platform mobile app with user authentication, core features, and basic UI",
                "start_week": 1,
                "duration_weeks": 3,
            ...
            },
            {
                ...
                "project_summary": "Enhance mobile app with advanced features, push notifications, and offline support",
                "start_week": 3,
                "duration_weeks": 3,
                "assigned_person_ids": teams["team_a"]
            },
            # Team B Projects
            {
                ...
                "project_summary": "Create real-time analytics dashboard with data visualization and basic reporting",
                "start_week": 1,
                "duration_weeks": 2,
                "assigned_person_ids": teams["team_b"]
            },
            {
                "project_name": "Data Pipeline Optimization",
                "project_summary": "Build scalable data pipeline with ETL processes, data warehouse integration, and automated reporting",
                "start_week": 3,
                "duration_weeks": 3,
                "assigned_person_ids": teams["team_b"]
            }
    ...
    # Run for 5 weeks (5 * 5 days * 8 hours * 60 minutes)
    ticks_total = 5 * 5 * 8 * 60
...
def main() -> int:
    log("=" * 60)
    log("Multi-Team 5-Week Full Simulation")
    log("=" * 60)
    handles: list[_Srv] = []
    people: List[Dict[str, Any]] = []
    teams: Dict[str, Any] = {}
